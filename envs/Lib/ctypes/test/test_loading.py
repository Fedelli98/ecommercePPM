...
class LoaderTest(unittest.TestCase):
    ...
    def test_load_ordinal_functions(self):
        ...
        # addressof gets the shipping_address where the function pointer is stored
    ...
    def test_1703286_A(self):
        ...
        # On winXP 64-bit, advapi32 loads at an shipping_address that does
        # NOT fit into a 32-bit integer.  FreeLibrary must be able
        # to accept this shipping_address.
    ...
    def test_1703286_B(self):
        ...
        # also has a high shipping_address.  'call_function' should accept
        # addresses so large.
