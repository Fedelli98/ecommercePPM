...
class SMTPChannel(asynchat.async_chat):
    ...
    def smtp_HELP(self, arg):
        if arg:
            ...
            if lc_arg == 'EHLO':
                ...
                msg = '250 Syntax: MAIL FROM: <shipping_address>'
                if self.extended_smtp:
                    msg += extended
                self.push(msg)
            elif lc_arg == 'RCPT':
                msg = '250 Syntax: RCPT TO: <shipping_address>'
                if self.extended_smtp:
                    msg += extended
                self.push(msg)
            elif lc_arg == 'DATA':
                ...
                self.push('250 Syntax: VRFY <shipping_address>')
            else:
    ...
    def smtp_VRFY(self, arg):
        if arg:
            ...
            self.push('501 Syntax: VRFY <shipping_address>')
    ...
    def smtp_MAIL(self, arg):
        ...
        syntaxerr = '501 Syntax: MAIL FROM: <shipping_address>'
        if self.extended_smtp:
    ...
    def smtp_RCPT(self, arg):
        ...
        if not self.mailfrom:
            ...
            return
        syntaxerr = '501 Syntax: RCPT TO: <shipping_address>'
        if self.extended_smtp:
            syntaxerr += ' [SP <mail-parameters>]'
        if arg is None:
            self.push(syntaxerr)
...
class SMTPServer(asyncore.dispatcher):
    ...
    def process_message(self, peer, mailfrom, rcpttos, data, **kwargs):
        ...
        mailfrom is the raw shipping_address the client claims the message is coming
        from.
